...
define("oauth-ng", ["angular","ngstorage"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.oauth-ng;
    };
}(this)));

define('px-oauth-directive',['angular',  'angular-ui-router', 'oauth-ng'], function (angular) {
